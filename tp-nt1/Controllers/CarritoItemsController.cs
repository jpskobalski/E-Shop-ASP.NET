...
namespace tp_nt1a_3.Controllers
{
    ...
    public class CarritoItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ValorUnitario,Cantidad,Subtotal,CarritoId,ProductoId")] CarritoItem carritoItem)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = nameof(Rol.Administrador))]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ValorUnitario,Cantidad,Subtotal,CarritoId,ProductoId")] CarritoItem carritoItem)
        {
